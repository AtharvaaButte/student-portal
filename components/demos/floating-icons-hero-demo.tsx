...
export default function FloatingIconsHeroDemo() {
    return (
        <FloatingIconsHero
            title="A Smarter Student Portal"
            subtitle="All your notices, events, assignments, and study resources—organized in one simple, interactive dashboard built for students."
